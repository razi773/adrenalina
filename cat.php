...
if (isset($_POST["id_Event"])) {
    $Event->supprimerEvent($_POST["id_Event"]);
    header('Location:afficherAlimentss.php');
}
$AlimentC = new EventC();
$Alim = new EventC();
$listeAliments = $Alim->afficherEvents();
if (isset($_POST['search'])) {
    $valueToSearch = $_POST['valueToSearch'];
    $listep = $AlimentC->afficherrech($valueToSearch);
} else {
    $listep = $AlimentC->afficherEvents();
}
$pC = new EventC();
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="modifierAliments.php?id_Event=<?PHP echo $user['id_Event']; ?>"> Modifier </a>
                        </td>
                    </tr>
                <?PHP
                }
