...
<nav>
        ...
        <div class="onglets">
            <a href="#">Home</a>
            <a href="formation.php">Produit</a>
...
<?php 
    ...
    <div class="card1">
      ...
      <table border="1" align="center">
          ...
          <tr>
          <td><h4 class="id"> <img src="<?php echo $article['id'].".png"; ?>"alt="" style= width='150px' height='150px'> </timezone_identifiers_list> </td>
       <td> <h4 class="title"><?php echo $article['titre'];?></h4> </td>
       <td> <h4 class="price"><?php echo $article['prix'];?>TND</h4> </td>
     <!-- </div>
      <div class="card-body">-->
     <td> <h4 class="description"><?php echo $article['description'];?></h4>  </td>
      
     <td> <h4 class="quantite">qunatite : <?php echo $article['quantite'];?></h4></td>
     <td> <p>par <?php echo (substr($article['vendeur'], 0, 200)); ?></p></td>
     <td><a href="supprimer_commande.php?id=<?php echo $commande['ID_Commande'];?>"><img src="image/supp.png" witdh='25px' height='25px'></a></td>
