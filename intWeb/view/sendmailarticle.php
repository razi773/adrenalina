...
$mail->Username = 'razi.sniha@esprit.tn';                 // SMTP username
$mail->Password = '201JMT4287';                           // SMTP password
$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to

$mail->setFrom('noreply@AIM.com', 'no-reply');
$mail->addAddress($_GET['email']);     // Add a recipient
$mail->addAddress('razi.sniha@esprit.tn');               // Name is optional
...
$mail->Body = 'salut,<br>
               merci pour interresse d article '.$a['id'] .'
                <br><br>
