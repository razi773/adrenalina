...
require_once     '../controller/commentaireC.php';
    ...
    if (isset($_POST['id'] ) && isset($_POST['nomcommentaire'] ) && isset($_POST['nbrearticle'] )) 
    {
            $commentaire = new commentaire($_POST['id'] , $_POST['nomcommentaire'] , $_POST['nbrearticle']);
...
<form action="" method="POST">
            <table border="1" align="center">
				...
				<tr>
                    ...
                    <td><input type="text" name="id_article" id="id_article" maxlength="20"></td>
                </tr>  
                ...
                <tr>
                    ...
                    <td><input type="text" name="commentaire" id="commentaire" maxlength="20"></td>
                </tr>  
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="pseudo" id="pseudo" maxlength="20"></td>
                </tr>   
                <tr>
                    <td>
