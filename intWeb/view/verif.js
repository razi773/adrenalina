...
function verif_types()
{
    var word = document.getElementById("types").value;
...
document.getElementById('Adresse').style.backgroundColor="#9C6";
}
}
...
function verif_RIB()
{
    var word = document.getElementById("RIB").value;
