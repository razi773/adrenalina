<?php 
    ...
    if(isset($_GET['t'],$_GET['id']) AND !empty($_GET['t']) AND !empty($_GET['id'])) {
        ...
        if($check->rowCount() == 1) {
            ...
            header('location: http://localhost/tache%20article/view/filtrarticle.php?id='.$getid);

        }else {
            exit('Erreur fatale. <a href="http://localhost/tache%20article/view/filtrarticle.php">revenir a l\'accueil</a>');
        }


    }else {
        exit('Erreur fatale. <a href="http://localhost/tache%20article/view/filtrarticle.php">revenir a accueil</a>');
    }